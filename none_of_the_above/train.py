...
def main(args):
    ...
    for item in train_data:
        ...
        for i, ans in enumerate(item["answers"]):
            ...
            five_inp_ids.append(inp_ids)
            five_tok_type_ids.append(tok_type_ids)
        five_inp_ids = pad_sequences(five_inp_ids, maxlen=MAXLEN, dtype="long", value=0, truncating="post", padding="post")
        five_tok_type_ids = pad_sequences(five_tok_type_ids, maxlen=MAXLEN, dtype="long", value=0, truncating="post", padding="post")
        input_ids.append(five_inp_ids)
        token_type_ids.append(five_tok_type_ids)
